...
auth()
  ...
  .then(friends => {
    function swapFriends(
      ...
      friendsLeftColl = document.querySelectorAll(
        "#left-list-wrap #first-list li"
      );
      friendsRightColl = document.querySelectorAll(
        "#right-list-wrap #first-list li"
      );
    ...
    let friendsLeftColl = document.querySelectorAll(
      "#left-list-wrap #first-list li"
    );
    let friendsRightColl = document.querySelectorAll(
      "#right-list-wrap #first-list li"
    );
